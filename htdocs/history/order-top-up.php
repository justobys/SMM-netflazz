			        ...
			        <div class="kt-portlet__head">
				        ...
				        <div class="kt-portlet__head-toolbar">
					        <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
					            <li class="nav-item">
					                <a class="nav-link" href="<?php echo $config['web']['url'] ?>history/order" role="tab">
					                Semua
					                </a>
					            </li>
					            <li class="nav-item">
					            ...
					            <li class="nav-item">
					                <a href="<?php echo $config['web']['url'] ?>history/order-top-up" aria-expanded="false" class="nav-link active">
					                Top Up
					                </a>  
					            </li>
					        </ul>

...
?>
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed">
	        ...
	        <div class="kt-header-mobile__logo">
		        <a href="<?php echo $config['web']['url'] ?>">
			        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/netflazz.png" style="width: 180px;"/>
		        </a>
	        </div>
	        <div class="kt-header-mobile__toolbar">
        ...
        <div class="kt-header__brand kt-grid__item" id="kt_header_brand">
	        <a class="kt-header__brand-logo" href="<?php echo $config['web']['url'] ?>">
		        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/netflazz.png" style="width: 150px;" class="kt-header__brand-logo-default"/>
		        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/netflazz.png" style="width: 150px;" class="kt-header__brand-logo-sticky"/>
	        </a>		
        </div>
        <!-- End Brand -->
		...
		<div class="kt-header__topbar-item kt-header__topbar-item--user">
		    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
			    ...
			    <span class="kt-header__topbar-icon"><img src="<?php echo $config['web']['url'] ?>assets/media/icon/user4.png" alt="image"></span>
			    <img alt="Pic" src="<?php echo $config['web']['url'] ?>assets/media/icon/user4.png" class="kt-hidden"/>
		    </div>
		<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
		...
		<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-2.png)">
            <div class="kt-user-card__avatar">
                <img class="kt-hidden" alt="Pic" src="<?php echo $config['web']['url'] ?>assets/media/logos/netflazz.png" />
                <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><img src="<?php echo $config['web']['url'] ?>assets/media/icon/user4.png" alt="image"></span>
            </div>

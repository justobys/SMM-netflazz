        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
	        <div class="kt-container ">
	            <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Daftar Aktifitas Kode Voucher</h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="#" class="kt-subheader__breadcrumbs-link">Daftar Aktifitas Kode Voucher</a>
	                </div>
	            </div>
	        </div>
        </div>
...
if (isset($_GET['search'])) {
    ...
    $cek_data = "SELECT * FROM kode_voucher WHERE kode LIKE '%$search%' ORDER BY id DESC"; // edit
} else {
    $cek_data = "SELECT * FROM kode_voucher ORDER BY id DESC"; // edit
}
if (isset($_GET['search'])) {
...
?>
                                <tr>
                                    ...
                                    <td width="10%"><span class="badge badge-primary"><?php echo $datanya['pembuat'] ?></span></td>
                                    <td width="7%"><span class="badge badge-warning"><?php echo $datanya['kode']; ?></span></td>
                                    <td width="15%"><span class="badge badge-danger">Rp <?php echo number_format($datanya['jumlah'],0,',','.'); ?></span></td>
...
?>
        ...
        <!-- End Page Data Activity Code Voucher -->
